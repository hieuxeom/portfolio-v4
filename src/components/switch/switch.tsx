...
const Switch = ({ label, name, size, isChecked, onChecked }: SwitchProps) => {
	const MapDivClass: Record<SwitchProps["size"], string> = {
	...
	const MapSpanClass: Record<SwitchProps["size"], string> = {
